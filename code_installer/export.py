#!/usr/bin/env python3
"""
Module d'export d'images de VM
Fournit une interface graphique pour exporter des images de disques de machines virtuelles avec rsync et suivi de progression
Basé sur le modèle de conception du module de chiffrement LUKS
"""
...
class VirtualImageExporter:
    """Interface graphique pour exporter des images de disques virtuels avec rsync"""
    ...
    def start_export(self):
        ...
        log_info("Starting export operation")
    ...
    def _export_worker(self,source_file,dest_dir):
        ...
        try:
            ...
            error_msg="Commande rsync introuvable. Veuillez installer rsync."
