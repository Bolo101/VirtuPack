...
class ImageFormatConverter:
    ...
    def setup_ui(self):
        ...
        # Split formats into two columns
    ...
    def analyze_image(self):
        ...
        try:
            ...
            # Use QCow2CloneResizer's get_image_info method
    ...
    def _conversion_worker(self, source_path, target_path, target_format):
        ...
        try:
            ...
            # Add compression if enabled and supported
...
def main():
    ...
    # Create a hidden root window for standalone mode
    root = tk.Tk()
    root.withdraw()
