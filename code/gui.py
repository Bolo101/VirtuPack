...
class DiskMountDialog:
    ...
    def get_unmounted_partitions(self):
        ...
        try:
            # Import utils functions properly
            from utils import get_disk_list, is_system_disk
            ...
            try:
                ...
                from log_handler import log_warning
            ...
            from log_handler import log_error
    ...
    def refresh_unmounted_partitions(self):
        ...
        try:
            from log_handler import log_info, log_warning
    ...
    def mount_and_select(self):
        ...
        try:
            ...
            if os.path.ismount(mount_point):
                ...
                try:
                    from utils import get_directory_space, format_bytes
...
class P2VConverterGUI:
    ...
    def mount_disk_dialog(self):
        ...
        try:
            ...
            error_msg = f"Error in mount disk dialog: {str(e)}"
            log_error(error_msg)
            messagebox.showerror("Mount Dialog Error", error_msg)
